...
user.cc = faker.finance.creditCardNumber('6379############');
 ...
 cy.get('#mat-radio-105 > .mat-radio-label > .mat-radio-container > .mat-radio-outer-circle').click();
 cy.get('.nextButton').click();
 cy.get('#checkoutButton').click()
// cy.get ('[class="confirmation"]').should('contain', 'Thnak you for your order purchase!' )
